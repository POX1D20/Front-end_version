    ...
    return (
        <div className="all">
            ...
            <div className="container_main">
                <div className="main_text">
                    ...
                    <p className="main_text_p">
                        ...
                        профессиональными партнерами и клиентами.
                    </p>
                    <p className="main_text_p">
                        Наша компания является одой из ведущих бетонных заводов,
                        среди динамично развивающихся производителей товарного
                        бетона (раствора), ЖБИ изделий в г.Ростове-на-Дону и
                        Ростовской области. Многолетний опыт нашей компании в
                        производстве товарного бетона и раствора всех марок,
                        позволяет получать высококачественную и высокопрочную
                        бетонную смесь, что неоднократно подтверждалось отзывами
                        наших клиентов и их постоянным сотрудничеством с
                        «КСМ-8».
                    </p>
                    <h2 className="main_text_h2">
                    ...
                    <p className="main_text_p">
                        ...
                        во все города Ростовской области.
                    </p>
                </div>
            </div>
            ...
            <div className="container_main">
                <div className="main_text">
                    <h2 className="main_text_h2">
                        ПРОИЗВОДСТВО БЕТОНА ВСЕХ МАРОК
                    </h2>
                    <p className="main_text_p">
                        Мы производим все марки товарного бетона от М-100 до
                        М-400 и товарного раствора от М-50 до М-200. Бетон
                    ...
                    <p className="main_text_p">
                        Доставка бетона осуществляется собственными
                        автобетоносмесителями. <br></br>Стоимость услуг Вы
